#
#  Be sure to run `pod spec lint Persist.podspec' to ensure this is a
...
MVI architecture implementation basic and needs for iOS framework to create valid applications for swift 4.2
  ...
  s.homepage     = "http://EXAMPLE/Persist"
  ...
  s.source       = { :git => "https://github.com/droideveloper/Persist.git", :branch => 'master' }
